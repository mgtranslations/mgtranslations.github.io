...
El suelo proviene de la descomposición de rocas y materia orgánica. Un suelo saludable, por volumen, debería ser:
- **45% minerales de roca**
- **5% materia orgánica**
- **50% espacio poroso** para agua y aire

Entre las muchas funciones importantes del suelo están:
- Hogar para organismos vivos como bacterias, hongos, nematodos, protozoos y lombrices de tierra
- Anclaje para raíces de plantas
- Reservorio de nutrientes para apoyar el crecimiento de las plantas
- Depósito y purificador de agua

La arena, el limo y la arcilla son las partículas minerales del suelo:
- Las partículas de **arena** son visibles a simple vista y se sienten ásperas.
- Las partículas de **limo** son más pequeñas (similares a una partícula de harina blanca) y se sienten suaves.
- Las partículas de **arcilla** son invisibles a simple vista y suelen ser planas.

La mayoría de los suelos son una mezcla de arena, limo y arcilla. El **franco** tiene una mezcla en proporciones aproximadamente iguales de las tres partículas.

La textura del suelo refleja la proporción de arena, limo y arcilla. Una buena estructura del suelo depende de organismos vivos (bacterias y hongos) y humus (materia orgánica descompuesta) que pegan las partículas formando **agregados**, que son los bloques de construcción del suelo.

---

### Propiedades del Suelo Arcilloso en Comparación con Otros Tipos

| Propiedad                   | Franco   | Franco Arenoso | Franco Limoso   | Arcilla y Franco Arcilloso                           |
|-----------------------------|----------|----------------|-----------------|------------------------------------------------------|
| **Capacidad de Retener Agua** | Moderada | Baja - Moderada| Alta            | Alta                                                 |
| **Fertilidad**              | Moderada | Baja           | Moderada        | Alta                                                 |
| **Permeabilidad**           | Moderada | Alta           | Baja - Moderada | Baja                                                 |
| **Sensación**               | --       | Áspera         | Suave, flexible cuando está húmedo pero no pegajoso | Dura cuando está seca, pegajosa cuando está húmeda; se puede moldear en cintas |
...
- Muchos tipos de hongos forman asociaciones beneficiosas (**micorrizas**) con las raíces de las plantas.
  - Las hifas de los hongos funcionan como extensiones de las raíces para obtener agua y nutrientes del suelo para la planta.
  - Las micorrizas también mejoran la estructura del suelo al agrupar las partículas en agregados.
...
- Estudios recientes en jardines urbanos donde se ha agregado MO durante años muestran niveles no saludables de fosfato y MO.
  - Niveles altos de fosfato dificultan la absorción de hierro y el desarrollo de micorrizas beneficiosas en las plantas, y contribuyen a la contaminación de los ríos.
- Si compras MO en comercios, el Departamento de Agricultura de Oregon analiza la MO para ver su contenido de nutrientes.
- Verifica que la MO tenga bajo contenido de fósforo si has estado agregando MO a tu suelo durante mucho tiempo.
...
- [Principios de Salud del Suelo, EC1647](https://catalog.extension.oregonstate.edu/)
- [Laboratorios Analíticos que Sirven a Oregon, EM8677](https://catalog.extension.oregonstate.edu/)
- [Aplicación de Cal para Subir el pH del Suelo para la Producción de Cultivos, EM9057](https://catalog.extension.oregonstate.edu/)

**Publicaciones de Extensión de la Universidad Estatal de Washington**
- [Cultivos de Cobertura para Jardineros del Oeste de las Cascadas, FS111E](https://pubs.extension.wsu.edu/extension-publications)
- [Guía de Suelos y Fertilizantes para Jardineros, EM063E](https://pubs.extension.wsu.edu/extension-publications)
- [Introducción a las Micorrizas para Jardineros, FS269E](https://pubs.extension.wsu.edu/extension-publications)
...
- [Demostración de Salud del Suelo](https://video.search.yahoo.com/yhs/search?p=ray+archuleta%27s+soil+health+demo+2014+custom)
