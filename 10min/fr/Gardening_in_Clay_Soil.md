...
Le sol provient de la décomposition des roches et de la matière organique. Un sol sain, en volume, devrait être composé de :
- **45 % de minéraux de roche**
- **5 % de matière organique**
- **50 % de vides** pour l’eau et l’air

Parmi les nombreuses fonctions importantes du sol, on trouve :
- Un habitat pour des organismes vivants comme les bactéries, les champignons, les nématodes, les protozoaires et les vers de terre
- Un ancrage pour les racines des plantes
- Un réservoir de nutriments pour soutenir la croissance des plantes
- Un réservoir et purificateur de l’eau

Le sable, le limon et l’argile sont les particules minérales du sol :
- Les particules de **sable** sont visibles à l’œil nu et ont une texture rugueuse.
- Les particules de **limon** sont plus petites (similaires à une particule de farine blanche) et sont douces au toucher.
- Les particules d’**argile** sont invisibles à l’œil nu et sont généralement plates.

La plupart des sols sont un mélange de sable, de limon et d’argile. Le **terreau** (loam) est un mélange à peu près égal de ces trois types de particules.

La texture du sol reflète la proportion de sable, de limon et d’argile. Une bonne structure de sol dépend des organismes vivants (bactéries et champignons) et de l’humus (matière organique décomposée) qui collent les particules ensemble pour former des **agglomérats** (peds), qui sont les blocs de construction du sol.

---

### Propriétés du sol argileux comparées à d’autres types

| Propriété                   | Terreau  | Terreau sablonneux | Terreau limoneux | Argile et terreau argileux                                   |
|-----------------------------|----------|--------------------|------------------|--------------------------------------------------------------|
| **Capacité de rétention d’eau** | Modérée | Faible - Modérée   | Élevée           | Élevée                                                       |
| **Fertilité**               | Modérée  | Faible             | Modérée          | Élevée                                                       |
| **Perméabilité**            | Modérée  | Élevée             | Faible - Modérée | Faible                                                       |
| **Toucher**                 | --       | Rugueux            | Doux, malléable lorsqu’humide mais non collant | Dur lorsqu’il est sec, collant lorsqu’il est humide ; peut être modelé en rubans |
...
- De nombreux types de champignons forment des associations bénéfiques (**mycorhizes**) avec les racines des plantes.
  - Les filaments fongiques fonctionnent comme de longs poils racinaires pour obtenir l’eau et les nutriments du sol pour la plante.
  - Les mycorhizes améliorent aussi la structure du sol en agrégant les particules de sol en agglomérats.
...
- Des études récentes sur les jardins urbains où de la MO a été ajoutée pendant des années montrent des niveaux malsains de phosphate et de MO.
  - Un taux élevé de phosphate empêche l’absorption du fer par la plante et le développement des mycorhizes bénéfiques, et contribue à la pollution des rivières.
- Si vous achetez de la MO chez des fournisseurs, le Département de l’Agriculture de l’Oregon analyse la MO pour sa teneur en nutriments.
- Vérifiez que vous achetez une MO pauvre en phosphore si vous en ajoutez à votre sol depuis longtemps.
...
- [Laboratoires d’analyses desservant l’Oregon, EM8677](https://catalog.extension.oregonstate.edu/)
- [Application de la chaux pour augmenter le pH du sol pour la production de cultures, EM9057](https://catalog.extension.oregonstate.edu/)

**Publications de l’Extension de l’Université d’État de Washington**
- [Cultures de couverture pour jardiniers amateurs à l’ouest des Cascades, FS111E](https://pubs.extension.wsu.edu/extension-publications)
- [Guide du jardinier amateur sur les sols et les engrais, EM063E](https://pubs.extension.wsu.edu/extension-publications)
- [Introduction aux mycorhizes pour les jardiniers, FS269E](https://pubs.extension.wsu.edu/extension-publications)
...
- [Démonstration de la santé des sols](https://video.search.yahoo.com/yhs/search?p=ray+archuleta%27s+soil+health+demo+2014+custom)
