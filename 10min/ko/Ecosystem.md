#### 10-Minute University™ · Clackamas County 마스터 가드너 협회가 OSU Extension 마스터 가드너™ 프로그램과 협력하여 지원합니다
...
#### 오리건 주립대 Extension Service는 인종, 피부색, 출신 국가, 종교, 성별, 성 정체성(성 표현 포함), 성적 지향, 장애, 나이, 혼인 여부, 가족/부모 상태, 공적 지원 프로그램으로부터 나온 소득, 정치적 신념, 유전 정보, 군 복무자 신분, 이전 인권 활동에 대한 보복 또는 보복 위협을 이유로 모든 프로그램, 서비스, 활동, 자료에서 차별을 금지합니다. (모든 금지 사유가 모든 프로그램에 적용되는 것은 아닙니다.)
---