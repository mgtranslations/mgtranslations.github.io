...
##### オレゴン州立大学エクステンションサービスは、人種、肌の色、出身国、宗教、性別、ジェンダーアイデンティティ（ジェンダー表現を含む）、性的指向、障がい、年齢、婚姻状況、家族・親の状況、公的扶助による収入、政治的信念、遺伝情報、退役軍人、過去の公民権活動に対する報復または仕返しを理由とする、すべてのプログラム、サービス、活動、資料における差別を禁止します（すべての禁止理由がすべてのプログラムに該当するわけではありません）。
---